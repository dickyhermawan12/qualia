...
module.exports = {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      ...
      template:  'resources/qualiavconapp/web/index.html',
    }),
  ...
  resolve: {
    alias: {
      ...
      'agora-react-native-rtm': path.join(__dirname, 'resources/qualiavconapp/bridge/rtm/web/index.ts'),
      ...
      'react-native-agora$': path.join(__dirname, 'resources/qualiavconapp/bridge/rtc/webNg/index.ts'),
    },
